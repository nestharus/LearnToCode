...
*               O greater than O
*               O less than O
*               O greater than or equal to O
*               O less than or equal to O
*
**********************************************************************
*
*   Variable Browser
...
public class BooleanBrowser extends JPanel
    ...
    public BooleanBrowser() {
        ...
        // the function browser itself:
        JScrollPane funcBrowser = new JScrollPane(tree);
